...
public class AlipayMarketingCardTemplateCreateModel extends AlipayObject {
	...
	private static final long serialVersionUID = 4557772545282942673L;
	 ...
	 * 卡级别配置
	 */
	@ApiListField("card_levle_conf")
	@ApiField("template_card_level_conf_d_t_o")
	private List<TemplateCardLevelConfDTO> cardLevleConf;
...
text: 文本
	...
	public List<TemplateCardLevelConfDTO> getCardLevleConf() {
		return this.cardLevleConf;
	}
	public void setCardLevleConf(List<TemplateCardLevelConfDTO> cardLevleConf) {
		this.cardLevleConf = cardLevleConf;
	}
